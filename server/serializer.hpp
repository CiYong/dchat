...
public:
    ...
    struct BaseVisitor {
        ...
        virtual void operator()(const char* name_, const int& value_) {}
        virtual void operator()(const char* name_, const uint32_t& value_) {}
        virtual void operator()(const char* name_, const std::string& value_) {}
        virtual void operator()(const char* name_, const std::vector<int32_t>& value_) {}
        virtual void operator()(const char* name_, const std::vector<int64_t>& value_) {}
        virtual void operator()(const char* name_, const std::vector<int16_t>& value_) {}
        virtual void operator()(const char* name_, const std::vector<std::string>& value_) {}
        virtual bool operator()(const char* name_, const TestInner& value_) {}
//        virtual bool operator()(const char* name_) {}
    };
    ...
    struct HashVisitor : public BaseVisitor {
        ...
        void operator()(const char* name_, const std::vector<int32_t>& value_) {
        ...
        void operator()(const char* name_, const std::vector<int64_t>& value_) {
            _content.append(name_);
            _content.append(" ");
            for (auto& val : value_) {
                _content.append(std::to_string(val) + ",");
        ...
        void operator()(const char* name_, const std::vector<int16_t>& value_) {
            _content.append(name_);
            _content.append(" ");
            for (auto& val : value_) {
                _content.append(std::to_string(val) + ",");
...
//        BaseVisitor* visitor = nullptr;
        ...
        auto redis_pair = drift::orm::redis_hash_pack(value_);

        switch (drift::traits::visitable<T>::orm_type()) {
        case RedisType::Hash:
//            visitor = new HashVisitor;
            cmd = const_cast<char*>("HSET");
            break;
        case RedisType::String:
//            visitor = new StringVisitor;
            cmd = const_cast<char*>("SET");
            redis_pair.value = drift::orm::msgpack_pack<std::string>(value_);
            break;
        default:
            return {};
        }
...
//        delete visitor;
        ...
        return {cmd, redis_pair.key, redis_pair.value};
    }
};
...
//    }
    ...
    T deserialize(content_string& content_) {
        return drift::orm::msgpack_unpack<T>(std::string(content_));
    }
